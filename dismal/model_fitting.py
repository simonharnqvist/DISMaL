...
def fit_all(S):
    ...
    models["im_2stage_asym"] = DemographicModel(
        model_name="im_2stage_asym", pop_size_change=False, migration=True, assymmetric_m=True).infer(S=S)
    ...
    models["iim_asym"] = DemographicModel(model_name="iim_asym", pop_size_change=True, migration=True, mig_rate_change=True,
                                          assymmetric_m_star=True, remove_mig_params=["M_prime_star"]).infer(S=S)
    models["sc_asym"] = DemographicModel(model_name="sc_asym", pop_size_change=True, migration=True, mig_rate_change=True,
                                         assymmetric_m_prime_star=True, remove_mig_params=["M_star"]).infer(S=S)
    ...
    models["gim_asym1"] = DemographicModel(
        model_name="gim_asym1", pop_size_change=True, migration=True, mig_rate_change=True, assymmetric_m_star=True).infer(S=S)
    models["gim_asym2"] = DemographicModel(
        model_name="gim_asym2", pop_size_change=True, migration=True, mig_rate_change=True, assymmetric_m_prime_star=True).infer(S=S)
    models["gim_asym"] = DemographicModel(model_name="gim_asym", pop_size_change=True, migration=True,
                                          mig_rate_change=True, assymmetric_m_star=True, assymmetric_m_prime_star=True).infer(S=S)

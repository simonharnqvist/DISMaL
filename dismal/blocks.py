...
def gff3_to_blocks(gff3_path, blocklen, min_block_distance, genomic_partition="intron", parquet_path=None):
    ...
    partitions_df = gff[gff["type"] == genomic_partition]
    ...
    blocks_unfiltered = pd.concat([_expand_partitions(partitions_min_blocklen.iloc[row, :],
                                                      ...
                                                      range(len(partitions_min_blocklen))])
